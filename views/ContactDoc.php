...
class ContactDoc {
    ...
    private function validateForm() { 
      ...
      private function showFormStart() {
        echo "<p>If you have any questions or comments, please feel free to contact me using the form below.</p>
      ...
      private function showFormField($fieldName, $label, $data, $options = NULL) {
        if ($options == NULL) {
          echo "
          <div>
